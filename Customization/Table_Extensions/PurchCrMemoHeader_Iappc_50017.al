tableextension 50017 "Purch. CrMemo Header Ext." extends "Purch. Cr. Memo Hdr."
{
    fields
    {
        ...
        field(70001; "Total Line Amount"; Decimal)
        {
            ...
            Editable = false;
            CalcFormula = sum("Purch. Cr. Memo Line"."Line Amount" where("System-Created Entry" = const(false),
        ...
        field(70002; "Total Line Discount"; Decimal)
        {
            FieldClass = FlowField;
            Editable = false;
            CalcFormula = sum("Purch. Cr. Memo Line"."Line Discount Amount" where("System-Created Entry" = const(false),
                                                                "Document No." = field("No."), Quantity = filter(<> 0)));
        }
