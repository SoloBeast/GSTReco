report 50188 "Sales Invoice Export"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Sales Invoice';
    RDLCLayout = 'Customization\Reports\50188_SalesInvoiceExport.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(LUTBondNo; recLocation."LUT / Bond No.") { }
            column(ExportDeclaration; 'Supply Meant for Export / Supply to SEZ Unit or SEZ Developer for Authorized Operations Under Bond of Letter of Undertaking without Payment of IGST.') { }
            ...
            column(BankSwiftCode; txtBnkSwiftCode) { } //Hemant
            column(BankMICRCode; txtBnkMICRCode) { }
            ...
            column(AmountInWords; txtAmountInWords[1] + txtAmountInWords[2] + ' ' + txtCurrencySymbol) { }
            column(CompaignName; '') { }
            ...
            column(LutFromDate; recLocation."Lut / Bond From Date") { }
            column(LutToDate; recLocation."Lut / Bond To Date") { }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                begin
                    ...
                    IF recUserSetup."Print Export Invoice" = 1 then
                        opPrintCopyOption := 1;
            ...
            begin
                ...
                if recBankAccount.Get("Sales Invoice Header"."Company Bank Account Code") then begin
                    ...
                    txtBnkSwiftCode := recBankAccount."SWIFT Code";
                    txtBnkMICRCode := recBankAccount."MICR Code";
    ...
    var
        ...
        txtBnkAddress: Text[50];
        txtBnkSwiftCode: Text;
        txtBnkMICRCode: Text[10];
