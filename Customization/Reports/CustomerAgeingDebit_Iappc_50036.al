report 50036 "Customer Ageing Debit Balance"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Customer Ageing Debit Balance';
    RDLCLayout = 'Customization\Reports\CustomerAgeingDebit_Iappc_50036.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                txtReportHeading := 'Customer Ageing Report Debit Balance As On ' + Format(dtAsOnDate);
