report 50037 "Vendor Ageing Credit Balance"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Vendor Ageing Credit Balance';
    RDLCLayout = 'Customization\Reports\VendorAgeingCredit_Iappc_50037.rdl';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                txtReportHeading := 'Vendor Ageing Report Credit Balance As On ' + Format(dtAsOnDate);
