report 50023 "Sales Cr. Memo Pre"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Sales Proforma';
    RDLCLayout = 'Customization\Reports\SalesCrMemoPre_Iappc_50023.al.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(DiscAmount; "Sales Line"."Line Discount Amount") { }
                column(DiscPer; "Sales Line"."Line Discount %") { }
