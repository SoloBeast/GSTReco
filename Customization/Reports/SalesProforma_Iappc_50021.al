report 50021 "Sales Proforma"
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Sales Proforma';
    RDLCLayout = 'Customization\Reports\SalesProforma_Iappc_50021.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    decTotalGSTAmount += decIGSTAmount + decCGSTAmount + decSGSTAmount;
                    recGSTSummary.Reset();
            ...
            trigger OnAfterGetRecord()
            begin
                if blnPrintProforma then
                    txtHeading := 'Proforma Invoice'
                else
                    if "Sales Header".Status = "Sales Header".Status::Released then
                        txtHeading := 'Sales Order'
                    else
                        txtHeading := 'Draft Sales Order';
    ...
    requestpage
    {
        layout
        {
            area(Content)
            {
                group(GroupName)
                {
                    field(blnPrintProforma; blnPrintProforma)
                    {
                        ApplicationArea = all;
                        Caption = 'Print as Proforma';
                    }
                }
            }
        }
    ...
    var
        ...
        txtStateGSTCode: Text;
        blnPrintProforma: Boolean;
        txtHeading: Text[30];
}